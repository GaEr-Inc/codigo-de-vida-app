  ...
  return (
    <Card style={props.style} onPress={props.onPress}>
      <Card.Title
        ...
        left={(props) => link === "" ? <Avatar.Icon icon={"account"} size={50} style={{backgroundColor: "#0033cc"}}/> : <Avatar.Image source={{ uri: link }} size={50} />} />
      {/* <Card.Content> */}
      {/* <Title>Juan Cardona</Title> */}
      {/* <Paragraph>1006899987</Paragraph> */}
      {/* </Card.Content> */}
      <Card.Actions>
        <Button color="black" icon={"download"} onPress={() => {
